...
def add_item_to_database(Name, Price, Description, ImageURL):
...
def get_all_items_from_database():
    ...
    cursor.execute("SELECT ItemID, Name, Price, Description, CreatedAt, ImageURL FROM Items WHERE RestaurantID = ?", (session['user_id'],))
